...
import com.insight.usercenter.common.utils.encrypt.AesEncryptor;
import com.insight.usercenter.common.utils.encrypt.Des3Encryptor;
import com.insight.usercenter.common.utils.encrypt.RsaEncryptor;
...
public final class Encryptor {
    ...
    public static String rsaEncrypt(String data, String publicKey) {
        try {
            return rsaEncryptor.encryptByPublicKey(data, publicKey);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String rsaDecrypt(String data, String privateKey) {
        try {
            return rsaEncryptor.decryptByPrivateKey(data, privateKey);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
