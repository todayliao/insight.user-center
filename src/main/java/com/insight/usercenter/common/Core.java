...
import com.insight.usercenter.common.utils.Encryptor;
...
public class Core {
    ...
    public TokenPackage creatorKey(Token token, String id, String deptId) {
        ...
        tokenPackage.setAccessToken(JsonUtils.toBase64(accessToken));
        tokenPackage.setRefreshToken(JsonUtils.toBase64(refreshToken));
